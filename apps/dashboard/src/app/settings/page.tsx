        ...
        <div className="max-w-7xl mx-auto space-y-10">
          ...
          <Card className="border border-neutral-200 bg-white shadow-sm hover:shadow-md transition-shadow duration-200 rounded-lg">
            ...
            <CardContent>
              <div className="space-y-3">
                <div className="p-4 rounded-xl border border-border hover:bg-surface-active transition-colors duration-200">
          ...
          <div className="pt-8 border-t border-neutral-200">
            ...
            <CardContent className="space-y-0">
              <div className="flex items-center justify-between py-4 border-b border-neutral-200 hover:bg-surface-active px-4 transition-colors duration-200">
              ...
              <div className="flex items-center justify-between py-4 hover:bg-surface-active px-4 transition-colors duration-200">
