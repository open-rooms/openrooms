...
// Clients - Human user/person silhouette (pink-rose #FDA4AF, matching CTA)
export const ClientsIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 96 96" fill="none" xmlns="http://www.w3.org/2000/svg">
    {/* Head */}
    <circle cx="48" cy="32" r="16" fill="#FDA4AF" stroke="#000" strokeWidth="2.5"/>
    {/* Eyes */}
    ...
    <circle cx="48" cy="8" r="3" fill="#FDA4AF" stroke="#000" strokeWidth="2"/>
    {/* Body / shoulders */}
    <path d="M18 82 C18 64 30 56 48 56 C66 56 78 64 78 82"
      fill="#FDA4AF" stroke="#000" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
    {/* Shirt details */}
...
export const DeveloperIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 96 96" fill="none" xmlns="http://www.w3.org/2000/svg">
    {/* Laptop lid / screen */}
    <rect x="10" y="20" width="76" height="48" rx="8" fill="#EA580C" stroke="#000" strokeWidth="2.5"/>
    {/* Screen bezel inner */}
    <rect x="18" y="28" width="60" height="34" rx="4" fill="#fff" opacity="0.9"/>
    {/* < bracket */}
    <path d="M32 38 L24 45 L32 52" stroke="#EA580C" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
    {/* > bracket */}
    <path d="M52 38 L60 45 L52 52" stroke="#EA580C" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
    {/* / slash */}
    <line x1="44" y1="36" x2="40" y2="54" stroke="#EA580C" strokeWidth="2.5" strokeLinecap="round"/>
    {/* Laptop hinge */}
    <rect x="10" y="66" width="76" height="4" rx="2" fill="#000" opacity="0.15"/>
    {/* Keyboard base */}
    <rect x="6" y="70" width="84" height="8" rx="4" fill="#EA580C" stroke="#000" strokeWidth="2"/>
    {/* Trackpad */}
